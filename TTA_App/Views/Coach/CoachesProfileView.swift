...
struct CoachesProfileView: View {
    ...
    @State private var userRole: String = "Coach"
                    ...
                    ScrollView {
                        VStack(spacing: 24) {
                            ...
                            if isEditing {
                                ...
                                // Profile Information
                                VStack(spacing: 20) {
                                    CoachProfileInfoRow(icon: "envelope.fill", title: "Email", value: email, userRole: userRole)
                                    CoachProfileInfoRow(icon: "phone.fill", title: "Phone", value: phoneNumber.isEmpty ? "Not provided" : phoneNumber, userRole: userRole)
                                    CoachProfileInfoRow(icon: "calendar", title: "Date of Birth", value: formatDate(dateOfBirth), userRole: userRole)
                                    CoachProfileInfoRow(icon: "person.fill", title: "Gender", value: gender, userRole: userRole)
                                }
                                .padding(20)
                                .background(Color.white)
                                .cornerRadius(12)
...
struct CoachProfileInfoRow: View {
    let icon: String
    let title: String
    let value: String
    let userRole: String
