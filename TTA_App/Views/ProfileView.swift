                ...
                if isLoading {
                    ...
                    ScrollView {
                        VStack(spacing: 24) {
                            ...
                            ZStack {
                                Circle()
                                    .fill(userRole == "Student" ? Color(red: 251/255, green: 146/255, blue: 60/255) : Color(red: 167/255, green: 139/255, blue: 250/255))
                            ...
                            if isEditing {
                                VStack(alignment: .leading, spacing: 20) {
                                    ...
                                    Button(action: saveProfile) {
                                        ZStack {
                                            Rectangle()
                                                .fill(userRole == "Student" ? Color(red: 251/255, green: 146/255, blue: 60/255) : TailwindColors.violet600)
                                                .cornerRadius(8)
                                                .frame(height: 50)
                                ...
                                VStack(spacing: 8) {
                                    ...
                                    Text(userRole)
                                        .font(.system(size: 16))
                                        .foregroundColor(userRole == "Student" ? Color(red: 251/255, green: 146/255, blue: 60/255) : TailwindColors.violet600)
                                        .padding(.horizontal, 16)
                                        .padding(.vertical, 8)
                                        .background(userRole == "Student" ? Color(red: 255/255, green: 237/255, blue: 213/255) : TailwindColors.violet100)
                                        .cornerRadius(16)
                                }
                                ...
                                VStack(spacing: 20) {
                                    ...
                                    ProfileInfoRow(icon: "phone.fill", title: "Phone", value: phoneNumber.isEmpty ? "Not provided" : phoneNumber)
                                    ProfileInfoRow(icon: "calendar", title: "Date of Birth", value: formatDate(dateOfBirth))
                                    ProfileInfoRow(icon: "person.fill", title: "Gender", value: gender)
                                }
                                .padding(20)
                                .background(Color.white)
                                .cornerRadius(12)
                                ...
                                Button(action: {
                                    ...
                                    .frame(maxWidth: .infinity)
                                    .frame(height: 50)
                                    .background(userRole == "Student" ? Color(red: 251/255, green: 146/255, blue: 60/255) : TailwindColors.violet600)
                                    .cornerRadius(8)
                                }
                                .padding(.horizontal, 20)
                                .padding(.top, 20)
